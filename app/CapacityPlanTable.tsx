            ...
            <table className="min-w-full text-sm text-left border-collapse mb-6">
                ...
                <tbody>
                    ...
                    <tr className="border-b-2 border-purple-200 bg-purple-50">
                        ...
                        <td className="p-4 text-center text-purple-300">-</td>
                            ...
                            return (
                                <td key={i} className="p-2 text-center">
                                    <input
                                        ...
                                        className={`w-20 p-2 text-center font-black text-base rounded outline-none transition-colors ${isOverridden ? 'border-2 border-amber-400 bg-amber-100 text-amber-800' : 'border-2 border-transparent bg-transparent text-purple-700 hover:bg-purple-100 hover:border-purple-300'}`}
                                    />
                                </td>
                            );
                        })}
